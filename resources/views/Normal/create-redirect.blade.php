...
<html lang="en">
    ...
    <head>
        ...
        * Middle Layer Pill Container */ .pill-container {
        ...
        /* Button Styling */
        .btn-cyan {
            background-color: rgb(118, 229, 200);
            border: none;
            color: rgb(0, 0, 0);
            font-size: 1rem;
            padding: 10px 20px;
        ...
        /* Ensure Full Height for Middle Section */
        .vh-100 {
            height: 100vh;
        }
        </style>
    ...
    <body class="body-bg">
        ...
        <div class="horizontal-main-wrapper">
                            ...
                            <div class="horizontal-menu">
                                <nav>
                                    <ul id="nav_menu">
                                        ...
                                        <li><a href="{{url('mydoctor')}}"><i class="fa fa-briefcase"></i> <span>View My
                                                    Doctor</span></a></li>
                                        <li><a href="{{url('chatss')}}"><i class="fa fa-comments"></i> <span>Chat
                                                    Front-desk</span></a></li>
                                        @elseif(Auth::user()->role_name !== 'Normal User')
                                        <li><a href="{{url('Guests')}}"><i class="fa fa-home"></i> <span>Home</span></a>
                                        </li>
                                        <li><a href="{{url('Guests')}}"><i class="fa fa-briefcase"></i> <span>View
                                                    Services Offer</span></a></li>
                                        <li><a href="{{url('chatss')}}"><i class="fa fa-comments"></i> <span>Chat
                                                    Front-desk</span></a></li>
                                        @endif
                                        @endauth
            ...
            <div class="container-display animate__animated  animate__zoomInUp
 ">
                <div class="cardboxzz">
                    <h3>Appointment Created Successful</h3>
                    <ul>
                        <li style="background-color:#28a745;">
                            <a href="{{url('myappointment')}}"
                                style="color: white; text-decoration: none; display: block; padding: 10px;">View
                                Appointment</a>
                        </li>
                        <li style="background-color:#6c757d;">
                            <a href="{{url('create_appointmentsss')}}"
                                style="color: white; text-decoration: none; display: block; padding: 10px;">Create
                                Appointment Again</a>
                        </li>
                    </ul>
