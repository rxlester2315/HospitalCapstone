    ...
    <div align="center" style="padding:70px;">
        <table>
            <tr style="background-color:black;">
                ...
                <th style="padding:20px; color:white;">Specialty</th>
                <th style="padding:20px; color:white;">Doctor Selected</th>
                <th style="padding:20px; color:white;">Email Address</th>
                <th style="padding:20px; color:white;">Date</th>
                <th style="padding:20px; color:white;">Time</th>
            ...
            <tr>
                ...
                <td style="padding:20px; color:black;">{{$appoint->departments}}</td>
                <td style="padding:20px; color:black;">{{$appoint->employees}}</td>
                <td style="padding:20px; color:black;">{{$appoint->email}}</td>

                <td style="padding:20px; color:black;">{{$appoint->date}}</td>
                <td style="padding:20px; color:black;">{{$appoint->time}}</td>

                <td style="padding:20px; color:black;">{{$appoint->message}}</td>
                <td style="padding:20px; color:black;">{{$appoint->status}}</td>
                <td>
                    <a style="padding: 5px 10px; font-size: 12px;" class="btn btn-success btn-sm"
                        href="{{url('approved', $appoint->id)}}">Approve</a>
                </td>
                <td>
                    <a style="padding: 5px 10px; font-size: 12px;" class="btn btn-danger btn-sm"
                        href="{{url('canceled', $appoint)}}">Cancel</a>
                </td>
