...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="sidebar" id="sidebar">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 607px;">
                <div class="sidebar-inner slimscroll" style="overflow: hidden; width: 100%; height: 607px;">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="#" class="active subdrop"><i class="la la-table"></i> <span> Tables </span>
                ...
                <div class="slimScrollBar"
                    style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 478.087px;">
                </div>
