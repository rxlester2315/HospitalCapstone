...
<html lang="en">
        ...
        <div class="horizontal-main-wrapper">
            ...
            <div class="container mt-5">
                <div class="note">
                    ...
                    <h2>NOTE!</h2>
                    <p>If you received this note, your verification request has been submitted. Please wait for the
                        admin's
                        decision</p>
 ...
 ">
                    ...
                    <div class="card-body">
                        ...
                        @if(isset($guessinfo))
                        <input type="text" class="form-control" id="firstName" value="{{ $guessinfo->firstName }}"
                            readonly>
                        @else
                        ...
                        <form class="mt-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="Email Address"
                                    value="{{$guessinfo->email}}" value="(123) 456-7890" readonly>
                            </div>
                            <div class="form-group">
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2024. All right reserved.</a>.
                    </p>
                </div>
            </footer>
            <!-- footer area end-->
