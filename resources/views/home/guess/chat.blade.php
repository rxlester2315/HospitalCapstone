...
.chat-sidebar p {
    justify-content: center;
    text-align: center;
    margin: 15px 0; /* Space above and below the paragraph */
}
...
.chat-sidebar li {
    border: 3px solid black; /* Border around each li */
    margin-bottom: 10px; /* Space between each li */
    padding: 10px; /* Padding inside each li */
    border-radius: 5px; /* Optional: rounded corners */
    background-color: #fff; /* Background color for li */
...
@media (max-width: 768px) {
    .chat-wrapper {
        flex-direction: column; /* Stack sidebar and chat main vertically */
    ...
    <div class="page-container">
     ...
     <div class="main-content-inner">
        ...
        <div class="chat-sidebar">
            ...
            <ul>
                <li class="main-det">Hospital Services (e.g., outpatient, inpatient, emergency, etc.)</li>
