...
<body>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="{{route('guest_view')}}">
                                    <button class="btn btn-unverified ml-lg-3" id="unverifiedBtn">Unverified</button>
                                </a>
                            </li>
                            @endif
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="{{ route('guest_view') }}">My Profile</a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-4 py-3 py-md-0">
                        <a href="{{url('chatss')}}" class="text-decoration-none">
                    ...
                    <div class="col-md-4 py-3 py-md-0">
                        <a href="one-health-link-here" class="text-decoration-none">
                            <div class="card-service wow fadeInUp">
                    ...
                    <div class="col-md-4 py-3 py-md-0">
                        <a href="pharmacy-link-here" class="text-decoration-none">
                            <div class="card-service wow fadeInUp">
    ...
    //         alert("This is an unverified action. Please verify your account.");
    //     }
    // 
    </script>
</body>
