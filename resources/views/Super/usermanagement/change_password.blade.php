...
@section('menu')
@extends('Super.sidebar.change_password')
@endsection
@section('content')
<div id="main">
    <header class="mb-3">
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form method="POST" action="" class="md-float-material">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-lg" name="new_confirm_password"
                                placeholder="Choose Confirm Password">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Change
                            Password</button>
                    </form>
                </div>
            </div>
